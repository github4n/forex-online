      ...
      <div class="order_type_right fl">
        <ul>
          <li>
            <span>新</span>
            <span
              :class="{red: showNewPrice.LastPrice - showNewPrice.PreSettlePrice >=0, green: showNewPrice.LastPrice - showNewPrice.PreSettlePrice < 0}">{{showNewPrice.LastPrice}}</span>
            <span>{{showNewPrice.TotalVolume}}</span>
          </li>
          <li>
            <span>卖</span>
            <span
              :class="{red: showNewPrice.AskPrice1 - showNewPrice.PreSettlePrice >=0, green: showNewPrice.AskPrice1 - showNewPrice.PreSettlePrice < 0}">{{showNewPrice.AskPrice1}}</span>
            <span>{{showNewPrice.AskQty1}}</span>
          </li>
          <li>
            <span>买</span>
            <span
              :class="{red: showNewPrice.BidPrice1 - showNewPrice.PreSettlePrice >=0, green: showNewPrice.BidPrice1 - showNewPrice.PreSettlePrice < 0}">{{showNewPrice.BidPrice1}}</span>
    ...
    watch: {
      ...
      $route: function () {
        if (this.$route.name == 'orderdetail') {
          // this.$store.state.market.selectId = '国际原油&CL&1901';
          this.$store.state.market.selectId = this.detail.CommodityName + "&" + this.detail.CommodityNo + "&" + this.detail.LastQuotation.ContractNo;
