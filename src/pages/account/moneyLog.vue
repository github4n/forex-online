...
<script>
	...
	export default{
		...
		mounted: function(){
			...
			document.getElementById('moneyLog').addEventListener('touchstart',function(e){
				e.preventDefault();  //阻止浏览器默认事件
			});
			//页面高度计算
			// var h = $("#topbar").height() + $(".money_total").height();
			// $(".log_list").css("height", window.screen.height - 50 - h + 'px');
		},
		activated: function(){
