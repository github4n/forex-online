<template>
	<div id="addMoney">
		...
		<div class="page_cont">
			...
			<div class="money_box">
				<span class="blue">当前总资产：</span>
				<span class="yellow">{{$route.query.total}}元</span>
				<!-- <i class="icon_arrow"></i> -->
				<!--<span class="white fr" @tap="toRecharge">去充值</span>-->
			</div>
			<div class="money_box">
				<span class="blue">亏损平仓线：</span>
				<span class="yellow">{{$route.query.loss}}元</span>
				<!-- <i class="icon_arrow"></i> -->
				<!--<span class="white fr" @tap="toRecharge">去充值</span>-->
			</div>
			<div class="ipt_box">
			...
			<ul>
				<li><span class="blue">换算汇率：</span><span class="white">{{rate}}元=1美元</span></li>
