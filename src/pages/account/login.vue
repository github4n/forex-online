					...
					this.$http.post(this.PATH + '/login', {emulateJSON: true}, {
						...
						if(data.success == true ){
							if(data.code == 1){
								...
								this.$store.state.forex.userInfo.userNum = this.phone;
								this.$store.state.forex.userInfo.password = this.pwd;
								this.$store.state.forex.userInfo.token = data.data.token;
								this.$store.state.forex.userInfo.secret = data.data.secret;
